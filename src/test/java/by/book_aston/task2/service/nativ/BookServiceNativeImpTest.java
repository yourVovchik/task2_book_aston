...
class BookServiceNativeImpTest {
    ...
    void init(){
        ...
        bookServiceNativeImp = new BookServiceNativeImp(bookDao);
    }
    ...
    void get() {
        ...
        BookDto bookDto = bookServiceNativeImp.get(id);
    ...
    void delete() {
        long id = 10;
        Mockito.when(bookDao.containsId(id)).thenReturn(true);
        bookServiceNativeImp.delete(id);
    ...
    void editName() {
        ...
        String name = "Book";
        Mockito.when(bookDao.containsId(id)).thenReturn(true);
        bookServiceNativeImp.editName(id,name);
    ...
    void editAuthors() {
        ...
        Mockito.when(bookDao.containsId(id)).thenReturn(true);
        bookServiceNativeImp.editAuthors(id,authorList);
    ...
    void containsId() {
        long id = 10;
        Mockito.when(bookDao.containsId(id)).thenReturn(true);
        assertTrue(bookServiceNativeImp.containsId(id));
    }
}